"""Config flow for Aquarium Hub -- point-and-click setup, no YAML.

Settings > Devices & services > Add integration > "Aquarium Hub" walks
...
class AquariumHubConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Aquarium Hub."""
